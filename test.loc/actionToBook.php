...
if($login){
	$addMemberToGroup=$conn->query("INSERT INTO `bookedtraining`( `MemberID`, `GroupTrainingName`, `GroupCoachId`, `GroupRunDate`, `GroupStartTime`) 
	VALUES ('$memberid','$grtype','$grcoach','$grdate','$grtime')");
...
if($addMemberToGroup){
  ...
  echo ('<h1 style="text-align: center;">YOU ARE SUCCESSFULLY BOOKED</h1>');
